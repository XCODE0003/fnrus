...
$(document).ready(function(){
    ...
    /* v4.39.3 — desktop full-bleed rails: первый слайд стартует от колонки
       ...
       считает в layout px. */
    /* v4.39.17 — ленты снова строго внутри контейнера на ≥1024
       (style.min.css v4.39.17): slidesOffsetBefore/After обнуляем —
       иначе Swiper сдвигает первую карточку от левого края контейнера
       и выталкивает последнюю за правый. */
