...
$(document).ready(function(){
    ...
    $("#cheat-video").on("popupOpen", function(){
        ...
        } else if (videoUrl && /(?:vimeo\.com\/|player\.vimeo\.com\/video\/)(\d+)/.test(videoUrl)) {
            var vmId = videoUrl.match(/(?:vimeo\.com\/|player\.vimeo\.com\/video\/)(\d+)/)[1];
            container.append('<iframe src="https://player.vimeo.com/video/' + vmId + '?autoplay=1" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>');
