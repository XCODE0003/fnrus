...
$(document).ready(function(){
    ...
    function _accClose(acc){
        ...
        b.style.height = b.scrollHeight + "px"; // fix current height
        void b.offsetHeight;                    // reflow
        acc.classList.remove("_active");
        b.style.height = "0px";                 // animate to closed
    }
    function _accOpen(acc){
        var b = acc.querySelector(".accordion__body"); if(!b) return;
        acc.classList.add("_active");
        b.style.height = b.scrollHeight + "px"; // animate to content height
        var te = function(){ b.style.height = "auto"; b.removeEventListener("transitionend", te); };
