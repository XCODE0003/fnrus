...
$(document).ready(function(){
    ...
    $(".game-cheats__slider-container").each(function(){
        var $container = $(this);
        var $slider = $container.find(".game-cheats-slider");
        if (!$slider.length) $slider = $container.next(".game-cheats-slider");
...
var cardTimeline, headerTimeline, section1Timeline, aboutHeadingTimeline, statusHeadingTimeline, loginTimeline,
    initAnimations = () => {};
