...
(function () {
    ...
    function animate(gsap) {
        ...
        /* ============================== FAQ ========================== */
        /* v4.39.19 — scroll-reveal для FAQ убран полностью: аккордеоны
           показываются мгновенно на всех страницах. Скрытие перед reveal
           давало «фигню с факью» — элементы могли зависнуть невидимыми
           или проявляться криво (smooth-scroll, IO-miss, быстрый скролл). */
        /* (FAQ reveal intentionally removed — instant visibility.) */
