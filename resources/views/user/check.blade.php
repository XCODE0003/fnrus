...
<head>
    ...
    <title>{{ __('site.check_title') }} #{{ $hash }}</title>
...
<section>
    <div class="my-5 text-center status-wrapper">
        ...
        @if($status == 3)
            ...
            <div class="d-block mb-4" style="font-weight: 500;font-size: 18px">{{ __('site.check_order_cancelled') }}</div>
            <a href="javascript:Telegram.WebApp.openTelegramLink('https://t.me/{{ $shop_username }}');" class="btn btn-primary">{{ __('site.check_return_to_bot') }}</a>
        @endif
        @if($status == 4)
            ...
            <div class="d-block mb-4" style="font-weight: 500;font-size: 18px">{{ __('site.check_payment_expired') }}</div>
            <a href="javascript:Telegram.WebApp.openTelegramLink('https://t.me/{{ $shop_username }}');" class="btn btn-primary">{{ __('site.check_return_to_bot') }}</a>
        @endif
    </div>
</section>
