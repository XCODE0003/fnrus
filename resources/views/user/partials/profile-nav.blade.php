{{--
  ТЗ §2 — the profile sidebar/nav, previously copy-pasted into
  profile.blade.php, orders.blade.php and referral.blade.php (which had
  drifted: its logout link read href="javascript;").
