...
<main>
    <section class="profile">
        <div class="content profile__container">
            @include('user.partials.profile-nav', ['active' => 'orders'])
            <div class="profile__main">
                <div class="profile__block">
                    <div class="profile__main__header">
                        <p class="profile__caption">{{ __('site.section_user_orders_title') }}</p>
                    </div>
                    <div class="profile__empty-block" id="orders_empty">
                        ...
                        <p class="profile__empty-block__caption">{{ __('site.section_user_orders_label_no_buys_title') }}</p>
                        <p class="profile__empty-block__text">{{ __('site.section_user_orders_label_no_buys_caption') }}</p>
                    </div>
                    <div class="profile__table profile__orders-table" id="orders_table" style="display: none">
                        <div class="profile__table__header">
                            <div class="profile__table__col">{{ __('site.section_user_orders_table_col_id') }}</div>
                            <div class="profile__table__col">{{ __('site.section_user_orders_table_col_title') }}</div>
                            <div class="profile__table__col">{{ __('site.section_user_orders_table_col_date_buy') }}</div>
                            <div class="profile__table__col">{{ __('site.section_user_orders_table_col_days') }}</div>
                            <div class="profile__table__col">{{ __('site.section_user_orders_table_col_price') }}</div>
                        </div>
                        <div class="profile__table__body" id="orders" data-simplebar></div>
                    </div>
                </div>
            </div>
        </div>
