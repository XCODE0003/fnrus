...
<section>
    <div class="my-5 text-center" style="width: 200px;margin:0 auto" id="result">
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.ok == 'paid'){
                    ...
                    $('#result').html(html);
                    Telegram.WebApp.close();
                } else if(data.ok == 'wait'){
                    var html = '<div class="d-block" style="margin-bottom: 13px"> <div class="spinner-border text-primary" style="width: 3rem; height: 3rem;" role="status"> <span class="visually-hidden">Loading...</span> </div> </div><div class="d-block mb-4" style="font-weight: 500;font-size: 18px">Ожидаем оплату</div>';
                    $('#result').html(html);
                }
            }
